        ...
        <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] pt-[clamp(5rem,10vw,11rem)] pb-0">
          ...
          <div className="mb-[clamp(3rem,6vw,8rem)]">
            ...
            <div className="overflow-hidden mb-8">
              <a ref={emailRef} href="mailto:abakwecarrington@gmail.com" className="block font-black text-white tracking-[-0.04em] leading-[0.88] hover:text-white/45 transition-colors duration-300 will-change-transform" style={{
              fontFamily: 'Satoshi, system-ui, sans-serif',
              fontWeight: 800,
            ...
            ease: EASE
              ...
              <a href="mailto:abakwecarrington@gmail.com" className="text-[0.62rem] tracking-[0.18em] uppercase text-white/28 hover:text-white/60 transition-colors duration-200 font-medium" style={{
              fontFamily: 'Satoshi, system-ui, sans-serif'
            }}>
                or email directly →
              </a>
          ...
          <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] py-[clamp(3rem,5vw,5rem)]">
            ...
            <div className="flex flex-col items-center sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-8 mb-10 sm:mb-12">
              ...
              ease: EASE
                ...
                <Image src="/sage/sage_prim_white.png" alt="Cybersage" width={130} height={32} className="opacity-40 hover:opacity-70 transition-opacity duration-300" />
              </motion.div>
